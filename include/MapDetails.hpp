...
namespace kk{
    ...
    private:
        ...
        static constexpr int objectrandnum = 400; ///< range for random object placement chance
        static constexpr int bushlimit = 10; ///< chance for bush limiter
        static constexpr int treelimit = 5; ///< chance for tree limiter
        static constexpr int seedmodifier = 3; ///< increases seed number so noise layer is different
        static constexpr float dfthreshold = 0.3f; ///< Dark Forest noise threshold 
        static constexpr float gthreshold = -0.6f; ///< Glade noise threshold 
        static constexpr float dwthreshold = -0.2f; ///< Deep Water noise threshold 
        static constexpr float mpthreshold = 0.8f; ///< Mountain Peak noise threshold 
        /**
